...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$redesigned_giggle_description = get_bloginfo( 'description', 'display' );
			if ( $redesigned_giggle_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $redesigned_giggle_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
